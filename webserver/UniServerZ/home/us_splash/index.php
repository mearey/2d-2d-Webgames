...
<title>Uniform Server ZeroXV - Splash page</title>
<meta name="Description" content="The Uniform Server ZeroXV" />
<meta name="Keywords" content="The Uniform Server,ZeroXV,MPG,Mike,Ric,UniServer,Olajide,BobS,SudeepJD,BrainStorm,sbourdon" />
...
<div id="wrap">
     ...
     <a href="https://www.uniformserver.com"><img src="images/logo.png" align="left" alt="The Uniform Server Zero" /></a>
       <div id="header_txt2" >
         <div style="position:absolute;">
           <b>ZeroXV <?php print "- ".$version; ?> </b><br />
           Apache 2.4.54 VS16 <br />
           MySQL 8.0.31 <br />
           PHP 7.0 to 7.4, 8.0, 8.1, 8.2
         </div>
       </div>
  </div>
  ...
  <div id="content">
    ...
    <p>Welcome to The Uniform Server ZeroXV default start splash page. This page and every other file are being served by Apache. Information can be found in folder <b>UniServer\docs</b>. For additional support for ZeroXV, see <a href="/us_docs/manual/index.html">documentation</a>.</p>
    <p>&nbsp;</p>
    <h2>Uniform Server <?php print $version; ?> Specifications</h2>
    <p>Plugins originally <b>included</b> / available at release</p>
    <p>&nbsp;</p>
  <table>
   <tr valign="top">
   <td>
    ...
    <ul>
      <li> <b>UniController v2.5.1</b></li>
	  <li> <b>Apache 2.4.54 VS16 openssl 1.1.1s</b></li>
      <li> <b>OpenSSL/1.1.1s</b></li>
	...
	<ul>
	  <li> <b>MySQL 8.0.31-community</b></li>
	  <li> Mariadb 10.6.11</li>
	</ul>
	<br />
